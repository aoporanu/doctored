                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 40px 0px 30px 0px;width:100%">
                                            You appointment booking successful with doctor {{ucfirst($doctorName)}} under Doctored Application, below are the details.
                                        </td>
                                    </tr>
                                </table>
                                <table border="1" cellpadding="1" cellspacing="0" width="100%">                              
                                   	<tr><td style="font-weight:bold"> Doctor Name</td><td>{{ucfirst($doctorName)}}</td></tr>
